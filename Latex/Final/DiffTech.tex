...
(
EN - I am trying to figure out a better way to describe and outline these sections.
As it stands, they are much more easy to desribe at the same time.
Furthermore, the main sources that I have are very much intense for designing the system.
I might just follow one proof and use the others as supplemental?
Or I might use the 2 most different proofs to show the slight differences?
Will take some time, but I will revisit it.
)
...
SRC - Turing Completness and Sid Meier's Civilization
