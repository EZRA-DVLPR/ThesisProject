...
It can be understood to those in Computer Science as a very abstract programming language, and actually forms the basis of Functional Programming Languages
\href{https://learn.saylor.org/mod/book/tool/print/index.php?id=33044&chapterid=13087}{SRC - functional programming}.




describe the basis of lambda calculus

re-create the TM from earlier using lambda calculus
(if i can, otherwise just use the default example from the below link)
