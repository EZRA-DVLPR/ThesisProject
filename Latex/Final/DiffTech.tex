...
In fact brainfuck, as seen in section \ref{sec:EstotericPL}, is used to demonstrate TC for its concise ruleset.
...
It was actually shown to be TC by Church himself.
...
Discuss the proof and how it can model a TM.