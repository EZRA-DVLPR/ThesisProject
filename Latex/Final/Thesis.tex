...
\usepackage{tocloft} % adjust spacing in TOC. adjust chapter and titles to be not bold in TOC. Also change List of Figures/Illustrations
...
% remove vertical space before & after the "List of Figures" title
...
%
    % Adjust List of Figures title, center, and make non-bold
    \renewcommand{\listfigurename}{\hfill List of Figures}
    \renewcommand{\cftloftitlefont}{\normalsize}
    \renewcommand{\cftafterloftitle}{\hfill}
%    
    % Add "Figure" prefix and ":" suffix for each entry in List of Figures
    \renewcommand{\cftfigpresnum}{Figure\ }
    \renewcommand{\cftfigaftersnum}{:\ }
%
}

% set space after "Figure X" by adjusting num width
...
\begin{document}
    ...
    \phantomsection % when clicked with e-reader or whatever, it takes you to the proper page
    \listoffigures % create the list of figures page dynamically
    ...
    \newpage
    \addtocontents{toc}{\protect\setcounter{tocdepth}{0}} % only show chapters in ToC
    ...
    \begin{singlespace}
        ...
        \begin{thebibliography}{}
            ...
            \bibitem{LittleBigCGoL} ashandore, “LittleBigLife - The Game of Life in LittleBigPlanet,” YouTube, Dec. 15, 2008. \href{https://www.youtube.com/watch?v=13GOFa1C4e4}{https://www.youtube.com/watch?v=13GOFa1C4e4}
            ...
            \bibitem{ProteusPaper} B. McClelland et al., “Towards a Systems Programming Language Designed for Hierarchical State Machines,” pp. 23–30, Jul. 2021, doi: https://doi.org/10.1109/smc-it51442.2021.00010.
            ...
            \bibitem{PHPWP} \href{http://facebook.com/syedbalkhi}{http://facebook.com/syedbalkhi}, “What is PHP? How PHP is Used in WordPress?,” WPBeginner, 2019. \href{https://www.wpbeginner.com/glossary/php/}{https://www.wpbeginner.com/glossary/php/}
            
            \bibitem{AntyParticles} I. Stewart, “The Ultimate in Anty-Particles,” Scientific American, vol. 271, no. 1, pp. 104–107, Jul. 1994, doi: https://doi.org/10.1038/scientificamerican0794-104.
            ...
            \bibitem{AntWiki} Wikipedia Contributors, “Langton,” Wikipedia, Feb. 16, 2024.
            ...
            \bibitem{vonNeumannBook} Y. N. Patt and S. J. Patel, Introduction to computing systems : from bits and gates to C and beyond. Boston: Mcgraw-Hill\textbackslash Higher Education, Cop, 2005.
    ...
    \input{ProofAssistants}
    
    \input{CodeSegments}

    \input{ProteusGrammar}
