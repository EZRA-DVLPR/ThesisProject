...
Coq is a proof assistant that allows users to codify their proofs and assert their results.
Coq was developed in OCaml \cite{OCamlCoq}.
For my experience using Coq alongside some other proof assistants Dafny and TLA+, see PAPER SECTION HERE

Some benefits of using FP are:
\begin{itemize}
    \item Unit Testing
    \item Debugging
    \item Concurrency
