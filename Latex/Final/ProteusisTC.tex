...
This is not a requirement for satisfying the capability of CGoL, but an extra nicety that would allow users to view the results.
As such, the above Proteus code demonstrates CGoL, and is verifiably TC.
